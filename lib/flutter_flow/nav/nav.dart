      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => BookpageWidget(
            ...
            episodes: params.getParam<String>(
              'episodes',
              ParamType.String,
              isList: true,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => const VipsubscriptionWidget(),
        ),
        FFRoute(
          name: 'booksearchpage',
          path: '/booksearchpage',
          builder: (context, params) => BooksearchpageWidget(
            name: params.getParam(
              'name',
              ParamType.String,
            ),
            authorname: params.getParam(
              'authorname',
              ParamType.String,
            ),
            coverphoto: params.getParam(
        ...
        FFRoute(
          name: 'emailverificationonpage',
          path: '/emailverificationonpage',
          builder: (context, params) => const EmailverificationonpageWidget(),
        )
