...
import 'submitbug_model.dart';
export 'submitbug_model.dart';
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              await launchUrl(Uri(
                                scheme: 'mailto',
                                path: 'RANJANSAHUSOUMIT@GMAIL.COM',
                              ));
                            },
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Requst a feature or submit a bug',
                        labelStyle:
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          'Thank You we Will check your Request',
                          style: TextStyle(
                            color:
